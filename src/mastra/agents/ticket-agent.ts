...
export const ticketAgent = new Agent({
  ...
  name: "Ticket Agent",
  description:
    "Finds exact Linear issue and Trello card locators, summarizes tickets, and turns them into an actionable draft plan.",
...
When Mentor delegates resource discovery, search the selected platform and return concise candidates containing kind "linear-issue" or "trello-card", the exact ID, title, canonical URL, and provider. These candidates are locators, not authoritative evidence or proof of ingestion. Do not present a discovery summary as indexed evidence.
